...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (MyApplication.getOrderCreateResponses() != null
            && !MyApplication.getOrderCreateResponses().isEmpty()) {
            OrderCreateResponse orderCreateResponse = MyApplication.getOrderCreateResponses().get(0);

            newOrderProfile = new OrderProfile(
